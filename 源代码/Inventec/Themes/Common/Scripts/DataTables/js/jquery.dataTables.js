...
$(function () {
    ...
    $(".nofenyesearchlisttable").DataTable({
        searching: true,
        lengthChange: false,
        info: false,
        pageLength: 100000,
    ...
    //kita create  有排序  不要查询
    $(".orderinglisttable").DataTable({
        searching: false,
        lengthChange: false,
        info: false,
        pageLength: 18,
    ...
    $(".searchnoPagelisttable").DataTable({
        searching: true,
        lengthChange: false,
        info: false,
        pageLength: 10000,
